...
% elements) by 3 double with a ascending order by the weights of the edges
% In ENT, there would be some negative value given the position of stimuli
% are randomly assigned(if participants indicate the stimuli on the left 
...
% reversed position(e.g., if -0.4 is located in row 4, column 2, it would be 
